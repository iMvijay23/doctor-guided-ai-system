...
RESULTS_PATH = "/home/vtiyyal1/data-mdredze1/vtiyyal1/askdocschat/doctor-guided-system/dgs_trial6_results_ica.json"
...
class DoctorGuidedSystem:
    ...
    def inject_empathy(self, question, verified_claims):
        ...
        empathetic_response = self.generate(prompt, max_new_tokens=512).strip()
